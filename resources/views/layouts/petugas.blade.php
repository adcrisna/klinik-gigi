...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="/petugas/home" class="logo">
                <span class="logo-mini"><b>Petugas</b></span>
                <span class="logo-lg"><b>Officer</b></span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ route('petugas.booking') }}">
                            <i class="fa fa-list-alt"></i> <span>Data Booking</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('petugas.payment') }}">
                            <i class="fa fa-money"></i> <span>Data Payment</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('logout') }}">
