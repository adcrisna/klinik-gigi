        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Tambah Data Dokter</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.addDokter') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-form-edit-klinik" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Form Ubah Data Dokter</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.updateDokter') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
                        ...
                        <div class="form-group has-feedback">
                            <label>Nama Dokter</label>
                            <input type="text" name="name" class="form-control" placeholder="Nama Dokter"
                                required>
                        </div>
                        <div class="form-group has-feedback">
                            <label>Alamat</label>
