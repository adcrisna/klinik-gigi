...
@section('content')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Data Klinik Cabang</li>
        </ol>
        <br />
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Data Klinik Cabang</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-success btn-edit-klinik"><i class="fa fa-edit">
                                                    Ubah</i></button> &nbsp;
                                            <a href="{{ route('admin.deleteKlinik', $value->id) }}"><button
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.addKlinik') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-form-edit-klinik" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.updateKlinik') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $('#data-klinik').on('click', '.btn-edit-klinik', function() {
            ...
            $('textarea[name=alamat]').val(row[2]);
            $('input[name=no_tlpn]').val(row[3])
            $('input[name=gmap]').val(row[4])
